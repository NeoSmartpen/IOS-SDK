...
void ShowPopupMessage(NSString *msg,NSString *title);
...
//static NSString * const NJBTRegResultNotification = @"NJBTRegResultNotification";
...
//static NSString * const NJBTDisconnectedNotification = @"NJBTDisconnectedNotification";
