...
//- (void)setNotebookInitTitle:(NSString *)title cTime:(NSDate*)cTime
//                       mTime:(NSDate*)mTime nId:(NSUInteger)nId imageName:(NSString *)imageName;
...
//- (BOOL) notebookExistArchivesPath:(NSUInteger)noteId;
//- (void) copyNotebookFromNeoNotebooksDirToArchivesDir:(NSUInteger)noteId;
